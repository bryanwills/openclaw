...
The match report searches scenario metadata, docs refs, code refs, taxonomy feature IDs, plugins, and provider requirements, then prints matching scenario refs.
