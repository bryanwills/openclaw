...
type EvidenceSummaryForTest = {
  ...
  entries: Array<{
    test: { id: string };
    mapping?: {
      coverage?: Array<{ featureId?: string }>;
    };
    result: {
      status?: string;
      ...
      expect(summary.entries).toEqual(
        expect.arrayContaining([
          expect.objectContaining({
            ...
            mapping: expect.objectContaining({
              coverage: expect.arrayContaining([
                expect.objectContaining({ featureId: "channels.telegram.canary" }),
              ]),
            }),
          ...
          expect.objectContaining({
            ...
            mapping: expect.objectContaining({
              coverage: expect.arrayContaining([
                expect.objectContaining({ featureId: "channels.telegram.mention-gating" }),
              ]),
            }),
